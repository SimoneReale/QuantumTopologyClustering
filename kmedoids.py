...
from create_new_models import create_bqm_even_spread
...
from solvers import simple_simulated_annealing, greedy_kmedoids, quantum_annealing
...
Delta, n, df_5g, df_taxi, importance_values = create_pechino_dataset(filter_radius=3000)
...
bqm, compute_objective_new =  create_bqm_even_spread(n, k, Delta, 3000, 2, 20000, 1)
...
print(f"Compute objective: {compute_objective_new(selected_medoids_bqm[0], Delta)}")
...
plot_medoids_on_map(df_5g, df_taxi, selected_medoids_bqm[0], Delta, 4000, "New model shortest")
...
plot_medoids_on_map(df_5g, df_taxi, selected_medoids_greedy_bias, Delta, 4000, "Greedy_medoids_bias")
